...
class KerasModel(object):
    def __init__(self):
        spliter = DatasetSpliter(conf_keras_first_go.dataset_path, conf_keras_first_go.vocab_size,
                                 conf_keras_first_go.max_length)
    ...
    def create_history(self):
        ...
        score = self.model.evaluate(self.x_test, self.y_test,
                                    batch_size=conf_keras_first_go.batch_size, verbose=1)
